...
class PostTagController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.posttag.index')->with('postTags',$postTag);
    }
    ...
    {
        return view('admin.pages.posttag.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.posttag.edit')->with('postTag',$postTag);
    }
