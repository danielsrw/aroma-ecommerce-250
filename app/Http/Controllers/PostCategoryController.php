...
class PostCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.pages.postcategory.index')->with('postCategories',$postCategory);
    }
    ...
    {
        return view('admin.pages.postcategory.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.postcategory.edit')->with('postCategory',$postCategory);
    }
